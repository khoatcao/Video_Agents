...
```json
{
  ...
  "youtube_metadata": {
    "title": "YouTube title in English max 97 chars with emoji",
    "description": "50-80 word English description with SEO keywords and CTA",
    "tags": ["tag1", "tag2", "tag3"],
    "category_id": "28"
  },
  "facebook_metadata": {
    "caption": "Hook sentence max 125 chars",
